...
DEV_QT="qtcreator qtcreator-doc qt4-dev-tools qt4-doc qt4-doc-html cmake"
...
EXTRAS_MULTIMEDIA="avidemux audacity devede handbrake-gtk acetoneiso
                  k3b dvd+rw-tools libk3b6-extracodecs"
...
KERNEL_HACKING="libncurses5-dev fakeroot"
